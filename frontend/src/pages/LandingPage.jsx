...
const LandingPage = ({ onNavigate }) => (
  <div className="bg-white font-sans">
    ...
    <header className="absolute top-0 left-0 right-0 z-10 bg-transparent">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 nav-bar">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8 text-white">
            <a href="#about" className="hover:text-green-300 transition text-lg">About</a>
            <a href="#features" className="hover:text-green-300 transition  text-lg">Features</a>
            <a href="#contact" className="hover:text-green-300 transition  text-lg">Contact</a>
          </div>
    ...
    <main>
      ...
      >
        <div className="z-10 max-w-3xl mx-auto px-4">
          ...
          <button 
            onClick={() => onNavigate('register')}
            className="bg-green-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-green-700 transition transform hover:scale-105"
          >
            Get Started Today
          </button>
        </div>
      ...
      <section id="about" className="py-20">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="bg-gray-200 rounded-lg p-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <div className="flex items-center mb-4">
              <div className="p-3 bg-white rounded-full mr-4">
                <UserCheck size={32} className="text-green-600" />
              </div>
              <h3 className="text-3xl font-bold text-gray-600">For Landowners</h3>
            </div>
          ...
          <div className="bg-gray-200 rounded-lg p-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-3xl font-bold text-gray-600">For Farmers</h3>
            </div>
            <p className="text-gray-500 mb-6">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-green-600 text-gray-100 rounded-full flex items-center justify-center text-4xl font-bold mb-4">1</div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-green-600 text-gray-100 rounded-full flex items-center justify-center text-4xl font-bold mb-4">2</div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-green-600 text-gray-100 rounded-full flex items-center justify-center text-4xl font-bold mb-4">3</div>
